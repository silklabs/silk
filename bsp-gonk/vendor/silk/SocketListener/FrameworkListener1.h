...
class FrameworkListener1 : public SocketListener1 {
public:
...
public:
    FrameworkListener1(const char *socketName);
    FrameworkListener1(const char *socketName, bool withSeq);
    FrameworkListener1(int sock);
    virtual ~FrameworkListener1() {}
