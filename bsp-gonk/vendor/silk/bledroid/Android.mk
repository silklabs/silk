...
ifeq ($(TARGET_QBLUETOOTH_A2DP_SOFT_HANDOFF),true)
LOCAL_CFLAGS += -DQBLUETOOTH_A2DP_SOFT_HANDOFF
endif

ifeq ($(TARGET_QBLUETOOTH_A2DP_AUDIO_FOCUS_REQUEST),true)
LOCAL_CFLAGS += -DQBLUETOOTH_A2DP_AUDIO_FOCUS_REQUEST
endif
