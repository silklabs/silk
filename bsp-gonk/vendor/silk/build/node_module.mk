...
$(LOCAL_BUILT_MODULE_MAIN_PATH): LOCAL_NODE_MODULE_GYP_FLAGS := $(LOCAL_NODE_MODULE_GYP_FLAGS)
...
$(LOCAL_BUILT_MODULE_MAIN_PATH): my_cc := $(my_cc)
$(LOCAL_BUILT_MODULE_MAIN_PATH): my_cxx := $(my_cxx)
...
$(LOCAL_BUILT_MODULE_MAIN_PATH):
    ...
    export SILK_GYP_FLAGS="-f make-android -DOS=android -Darch=$(or $(TARGET_2ND_ARCH),$(TARGET_ARCH)) $(LOCAL_NODE_MODULE_GYP_FLAGS)" && \
