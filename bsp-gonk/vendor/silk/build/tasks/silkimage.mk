...
# of /system/silk.  It may be pushed onto a device at /data/silk.img, and
# activated via |adb shell setprop persist.silk.root silk.img|.  When active it
# overrides the current contents of /system/silk.
